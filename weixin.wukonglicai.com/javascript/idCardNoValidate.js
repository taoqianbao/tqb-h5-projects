...
*/
function idCardNoValidate( card ) {
...
var
  ...
  verifyBirthday = function(year,month,day,birthday) {
    ...
    /*alert("parseInt(month)="+parseInt(month));
    alert("birthday.getFullYear()="+birthday.getFullYear());
    alert("year="+year+"month="+month+"day="+day);
    alert("birthday.getMonth() + 1="+(birthday.getMonth() + 1));
    alert("birthday.getDate()="+birthday.getDate());*/
    //年月日是否合理
